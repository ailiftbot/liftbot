...
# ── Logging ──────────────────────────────────────────────────────
# In production (DEBUG=False) Django swallows exceptions unless you
# configure LOGGING. This ensures all errors are printed to console
# (gunicorn captures them) and also written to a file in /tmp/liftbot/.

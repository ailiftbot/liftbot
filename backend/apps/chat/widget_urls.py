...
urlpatterns = [
    ...
    path('articles/search/', views.widget_search_articles, name='widget_search_articles'),
    path('articles/detail/', views.widget_article_detail, name='widget_article_detail'),
